...
return [
     ...
     */
    'Error' => [
        // En producción, omitir E_USER_DEPRECATED evita romper descargas binarias (p. ej. Excel)
        // cuando algún finder aún dispara avisos de CakePHP 5.
        'errorLevel' => $debug ? E_ALL : (E_ALL & ~E_USER_DEPRECATED),
        'skipLog' => [],
        'log' => true,
        'trace' => true,
