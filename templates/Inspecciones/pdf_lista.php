...
$tipoFormulario = $inspeccion->tipo_formulario ?? 'F17_TRACTO';
$formularioNumero = [
    'F17_TRACTO'   => 'F-17',
    'F18_CAMION'   => 'F-18',
    'F19_REMOLQUE' => 'F-19',
...
$formularioRev = $formularioNumero . ' REV.01';
$esCabina   = in_array($tipoFormulario, ['F17_TRACTO', 'F18_CAMION', 'F21_AUTOBUS']);
...
if ($tipoFormulario === 'F19_REMOLQUE') {
    ...
    // Orden oficial F-21 REV.01 (webroot/camposTXT/F-21_AUTOBUS.txt / f-21.pdf).
...
<table class="chk" cellspacing="0">
  <thead>
    <tr class="th-top">
      <th style="width:28px;">PUNTO NOM</th>
      <th style="width:14px;">D</th>
      <th style="width:14px;">V</th>
      <th style="width:14px;">M</th>
      <th class="th-concepto">CONCEPTO</th>
      <th style="width:34px;">Aprobado</th>
      <th style="width:38px;">Rechazado</th>
      <th style="width:26px;">N/A</th>
    </tr>
  </thead>
  <tbody>
