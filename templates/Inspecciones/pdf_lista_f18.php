<?php
/**
 * Lista de inspección — F-18 REV.01 Camión C-2/C-3 (Dompdf).
 * Plantilla exclusiva: no compartir con F-17/F-19/F-20/F-21.
 * Referencia: webroot/camposTXT/F-18_CAMION.txt + F-18.pdf
 *
...
// Esta plantilla es solo F-18; evita fugas de lógica de otros formatos.
$tipoFormulario = 'F18_CAMION';
$formularioNumero = 'F-18';
$formularioRev = 'F-18 REV.01';
$esCabina   = true;
$esRemolque = false;
$esDolly    = false;
$esCamion   = true;
...
if ($esRemolque) {
    foreach ($gruposLlantaF19 as $spec) {
        if (!in_array($spec['gn'], $gruposNum, true)) {
            continue;
        }
        $llTraseras = array_merge($llTraseras, $tireRowsF19($spec));
    }
}

/* ── Bloques de conceptos reutilizables (labels exactos de los PDFs) ── */

// LUCES — orden y marcas D/V/M según F-18_CAMION.txt / F-18.pdf.
$secLuces = [
  ['nom'=>'53','d'=>'','v'=>'✓','m'=>'','txt'=>'FAROS PRINCIPALES DOS O CUATRO VIENDO HACIA ADELANTE',                 'val'=> $il?->faros_principales],
  ['nom'=>'53','d'=>'','v'=>'✓','m'=>'','txt'=>'LUZ QUE ILUMINAN DURANTE EL DIA SI CUENTA DE COLOR BLANCO O AMARILLO', 'val'=> $il?->luz_diurna],
  ...
  ['nom'=>'65','d'=>'','v'=>'✓','m'=>'','txt'=>'PARABRISAS: GRIETAS, DESPOSTILLADO EN FORMA DE ESTRELLA DE 12.5 mm DE DIAMETRO EN LA BARRIDA DEL LIMPIPARABRISAS, DECOLORACION MAYOR AL 10% DE TODA LA SUPERFICIE, POLARIZADO QUE NO ES DE FABRICA, OBSTRUCCIONES, CONDICION', 'val'=> $il?->parabrisas],
  ...
  ['nom'=>'61','d'=>'','v'=>'✓','m'=>'','txt'=>'VENTANAS LATERALES, CONDICION, TIPO, ENTINTADO (POLARIZADO)',          'val'=> $il?->ventanas_laterales],
  ['nom'=>'62','d'=>'','v'=>'✓','m'=>'','txt'=>'VENTANA POSTERIOR, CONDICION',                                         'val'=> $il?->ventana_posterior],
  ['nom'=>'72','d'=>'','v'=>'✓','m'=>'','txt'=>'LIMPIA PARABRISAS: FUNCIONAMIENTO, PLUMAS DE HULE, BRAZOS',            'val'=> $il?->limpiaparabrisas],
  ['nom'=>'72','d'=>'','v'=>'✓','m'=>'','txt'=>'INYECTORES DE AGUA (SI CUENTA DE FABRICA) FALTANTES, NO FUNCIONAN',    'val'=> $il?->inyectores_agua],
  ['nom'=>'62','d'=>'','v'=>'','m'=>'','txt'=>'DEFENSA DELANTERA, FLOJA, FALTANTE, ROTA',                             'val'=> $il?->defensa_delantera],
  ['nom'=>'75','d'=>'','v'=>'✓','m'=>'','txt'=>'PLACA DE IDENTIFICACION',                                              'val'=> \App\Validation\InspeccionMexico::valorPlacaIdentificacion($il)],
];
...
// SISTEMA DE COMBUSTIBLE (GAS LP Ó GAS NATURAL) — F-18.
$secGasLp = [
...
$suspTraseraPdf = in_array($tipoFormulario, ['F18_CAMION', 'F21_AUTOBUS'], true)
    ...
    : $secSuspTrasera;
if (\App\Validation\TipoVehiculoRequisitos::esCamionLigero($tipoVehCod)) {
    $suspTraseraPdf = array_values(array_filter(
        $suspTraseraPdf,
        static function (array $f): bool {
            $t = $f['txt'];

            return !str_contains($t, 'SUSPENSIÓN DE AIRE')
                && !str_contains($t, 'VÁLVULA DE PROTECCIÓN DE PRESIÓN 65');
        }
    ));
}
...
$secNeuFull = [
  ...
  // Oficial F-18: GOBERNADOR y FUGAS llevan V+M (F-18.pdf / F-18_CAMION.txt).
  ['nom'=>'35','d'=>'','v'=>'✓','m'=>'✓', 'txt'=>'GOBERNADOR: TIEMPO DE CARGA NO MAS DE 3 minutos, ACTIVACION (80 PSI) /DESACTIVACION 117-135 PSI)', 'val'=> $sa?->gobernador],
  ...
  ['nom'=>'37','d'=>'','v'=>'✓','m'=>'✓', 'txt'=>'FUGAS DEL SISTEMA DE AIRE PRESION DEL TANQUE (80 Y 90 PSI), CAIDA DE PRESION 3 PSI POR MINUTO', 'val'=> $sa?->fugas_sistema],
...
// FRENOS NEUMÁTICOS — F-20 Dolly (formato oficial: incluye fugas, sin ABS).
$secNeuDolly = [
  ['nom'=>'34','d'=>'','v'=>'✓','m'=>'', 'txt'=>'MANGUERAS O TUBERÍA',                                 'val'=> $ch?->mangueras_tuberia],
  ['nom'=>'39','d'=>'','v'=>'✓','m'=>'', 'txt'=>'DEPÓSITO DE AIRE',                                     'val'=> $sa?->deposito_aire],
  ['nom'=>'37','d'=>'✓','v'=>'✓','m'=>'', 'txt'=>'FUGAS DEL SISTEMA DE AIRE PRESIÓN DEL TANQUE',         'val'=> $sa?->fugas_sistema],
  ['nom'=>'39','d'=>'','v'=>'✓','m'=>'', 'txt'=>'VÁLVULAS DEL SISTEMA DE AIRE: OPERACIÓN, ANTIRRETORNO, VÁLVULAS BIDIRECCIONALES, CONTAMINACIÓN, TANQUES DE AIRE, VÁLVULAS DE PURGA, EYECTORES DE HUMEDAD', 'val'=> $sa?->valvulas_sistema],
  ['nom'=>'39','d'=>'','v'=>'✓','m'=>'', 'txt'=>'VÁLVULAS DE CONTROL DEL SISTEMA DE AIRE: CONDICIÓN, OPERACIÓN, FRENADO DE ESTACIONAMIENTO, LIBERACIÓN DE FRENOS', 'val'=> $sa?->valvulas_control],
  ['nom'=>'40','d'=>'','v'=>'✓','m'=>'', 'txt'=>'COMPONENTES DEL SISTEMA DE AIRE: CONEXIONES Y MANGUERAS, LÍNEAS DE AIRE, UNIONES, EMPALMES', 'val'=> $sa?->componentes_conexiones],
  ['nom'=>'42','d'=>'','v'=>'✓','m'=>'✓','txt'=>'BALATAS ZAPATAS, DESGASTE REMACHADAS 4,8 mm, DESGASTE ADHERIDAS 3,2 mm', 'val'=> $fr?->balatas],
...
// CABINA — F-18 (INTERRUPTORES sin marca V, según oficial).
$secCabina = [
  ['nom'=>'52','d'=>'','v'=>'✓','m'=>'','txt'=>'ETIQUETA DEL FABRICANTE',                               'val'=> $cab?->etiqueta_fabricante],
  ['nom'=>'69','d'=>'','v'=>'✓','m'=>'','txt'=>'VISERA PARA EL SOL',                                    'val'=> $cab?->visera_sol],
  ['nom'=>'54','d'=>'','v'=>'','m'=>'','txt'=>'INTERRUPTORES, DE FAROS, DE LUCES, CALEFACCION, DESEMPAÑANTE, DIRECCIONALES, ADVERTENCIA DE PELIGRO, LIMPIAPARABRISAS', 'val'=> $cab?->interruptores],
  ['nom'=>'53','d'=>'','v'=>'✓','m'=>'','txt'=>'LUZ EN TABLERO Y PALANCA',                              'val'=> $cab?->luz_tablero_palanca],
  ['nom'=>'52','d'=>'','v'=>'✓','m'=>'','txt'=>'MANOMETRO DE AIRE',                                     'val'=> $sa?->manometro],
  ['nom'=>'39','d'=>'','v'=>'✓','m'=>'','txt'=>'PROTECCION DEL CAMION',                                 'val'=> $sa?->proteccion_camion],
  ['nom'=>'39','d'=>'','v'=>'✓','m'=>'','txt'=>'FRENO DE EMERGENCIA',                                   'val'=> $fr?->freno_emergencia],
  ['nom'=>'70','d'=>'','v'=>'✓','m'=>'','txt'=>'ESPEJOS RETROVISORES, COLOCACION, VISION, SOPORTES, CONDICION DE VIDRIO, SUPERFICIE', 'val'=> $il?->espejos_retrovisores],
  ['nom'=>'73','d'=>'','v'=>'✓','m'=>'','txt'=>'SISTEMA DE DESEMPAÑANTE',                               'val'=> $cab?->sistema_desempanante],
];
...
// Orden oficial F-18 REV.01 (F-18_CAMION.txt / F-18.pdf). Solo este formato.
...
$add($secciones, 'BATERÍA', [
    ['nom'=>'54','d'=>'','v'=>'✓','m'=>'','txt'=>'ACUMULADOR DE BATERIA, SOPORTE, POSTES, CUBIERTA', 'val'=> $ch?->bateria],
]);
// C2L = solo hidráulicos; C2/C3 = solo neumáticos.
$usaNeu = \App\Validation\TipoVehiculoRequisitos::usaFrenosNeumaticos($tipoVehCod);
$usaHid = \App\Validation\TipoVehiculoRequisitos::usaFrenosHidraulicos($tipoVehCod);
if ($usaNeu) {
...
$add($secciones, 'CABINA', $secCabina);
...
// Oficial F-18: XXXV/XXXVIII solo con frenos neumáticos (C2/C3). C2L no lleva mediciones de aire.
$medicionesComplementarias = $usaNeu ? [
    ...
    ['nom'=>'XXXVIII','d'=>'','v'=>'','m'=>'','txt'=>'Con el sistema de aire completamente cargado y el motor detenido se registra la caida de presion en PSI en un minuto: ' . $fmtNumPdf($sa?->caida_presion_psi, 'PSI'), 'val'=> null],
] : [];

/* ── Pie de medición: solo llantas activas del tipo (p. ej. C2L→4, C2→6, C3→10) ──
...
// C2L / C2L6 (hidráulicos): sin cámara de freno tipo abrazadera ni recorrido de varilla.
$mostrarCamaraVarillaPie = !$usaHid;
...
<style>
  ...
  /* Oficial F-18.pdf es A4 (595×842 pt). */
  ...
  * { box-sizing: border-box; }
  ...
  .chk th, .chk td { border:1pt solid #9bc4a4; padding:2px 4px; vertical-align:middle; }

  /* Encabezado de columnas: UNA sola vez (no en <thead> para que Dompdf no lo repita en cada hoja). */
  .chk tr.th-top td {
...
<!-- Tabla checklist principal: encabezado de columnas solo al inicio (no se repite por hoja). -->
...
<table class="pie-wrap" cellspacing="0">
  <tr>
    <!-- Tabla izquierda: LLANTA / DIBUJO / PRESIÓN<?= $mostrarCamaraVarillaPie ? ' / CÁMARA / VARILLA' : '' ?> -->
    <td class="col-l">
      <table class="ll-tbl" cellspacing="0">
        <thead>
          <tr>
            ...
            <?php if ($mostrarCamaraVarillaPie): ?>
        ...
        <tbody>
          <?php foreach ($numerosPie as $n):
            $ll = $llantaMap[$n] ?? null;
            $inicioGrupo = $mostrarCamaraVarillaPie
                && \App\Validation\Nom068Formato::esInicioGrupoPieCamaraVarilla((int)$n, $tipoPieVar);
...
<!-- Mediciones al final del checklist (sin repetir encabezado PUNTO NOM / D V M…). -->
<table class="chk" cellspacing="0">
  <tbody>
    <tr class="sec-row"><td colspan="8">MEDICIONES COMPLEMENTARIAS (XXXV / XXXVIII)</td></tr>
